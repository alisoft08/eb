...
namespace dby
{
    ...
    public:
        ...
        void printTable() {
            std::size_t index = this->_hash_function(K);
            this->table.at(index).push_back(std::make_pair(K, V));
        }
       

        //retorna un puntero al valor si la llave existe
        V* get(K key)
        {
